...
public class KIMFlowtype169ServiceTest {
  ...
  public void testSendERezeptToKIMAddress() {
    ...
    kIMFlowtype169Service.sendERezeptToKIMAddress(fromKimAddress, toKimAddress, "Hallo Apotheke", smtpHostServer,
        smtpUser, smtpPassword, eRezeptToken);
  }

  @Test
  public void testSearchSee() throws NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException,
  ...
  @Test
  public void testSearchTest() throws NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException,
      UnrecoverableKeyException, KeyManagementException {
  ...
  private void search(String searchDisplayName) throws FileNotFoundException, NoSuchAlgorithmException,
    ...
    FileInputStream certificateInputStream = new FileInputStream(
        "/home/manuel/Desktop/RU-Connector-Cert/no_ec_incentergy.p12");
