...
import health.ere.ps.service.gematik.ERezeptWorkflowServiceTest;
...
public class BearerTokenServiceTest {
    ...
    @Disabled
    public void test() {
        // ssh -R 1501:idp.erezept-instanz1.titus.ti-dienste.de:443 -R 1502:kon-instanz2.titus.ti-dienste.de:443 -R 1503:fd.erezept-instanz1.titus.ti-dienste.de:443 manuel@localhost
        RuntimeConfig runtimeConfig = new RuntimeConfig();
        runtimeConfig.getConfigurations().setConnectorBaseURL("https://localhost:1502");
        ...
        runtimeConfig.setIdpBaseURL("https://localhost:1501/auth/realms/idp");
        System.out.println(bearerTokenService.requestBearerToken(runtimeConfig, null, null));
    }
} 